# for -<*>~ SOURCE Theo ~<*>- edit By: @Source_Theo 
...
async def _(event):
    if event.fwd_from:
        return
    mentions = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝙏𝙝𝙚𝙤 𝑮𝑹𝑶𝑼𝑷 𝑫𝑨𝑻𝑨 𓆪\n** ⪼ المشرفـون في ۿذه المجموعه :** \n"
    reply_message = None
...
async def get_users(show):
    if show.fwd_from:
        return
    mentions = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝙏𝙝𝙚𝙤 𝑮𝑹𝑶𝑼𝑷 𝙏𝘼𝙂 𓆪\n**⪼ هييه تعالـو يحبابين**  𓎤: \n"
    reply_to_id = None
...
async def _(event):
    ...
    async for i in bot.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𝑺𝑼𝑹𝑪𝑬 𝙏𝙝𝙚𝙤    - 𝑮𝑹𝑼𝑶𝑷 𝑺𝑻𝑨𝑻𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
async def fetch_info(chat, event):
    ...
    caption = "<b> 𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 𝙏𝙝𝙚𝙤    - 𝑮𝑹𝑼𝑶𝑷 𝑫𝑨𝑻𝑨 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    ...
    if hasattr(chat_obj_info, "scam") and chat_obj_info.scam:
        ...
        caption = f"<b>𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝘿𝙀𝙑 - @XIX_A  𓆪</b>"
    return caption
