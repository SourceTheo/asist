...
@Source_Theo .on(admin_cmd(pattern="صلاة(?: |$)(.*)"))
async def get_adzan(adzan):
    ...
    if ZELZAL == "صنعاء" or ZELZAL == "اليمن":
	    ...
	    Source_Theo result = f"<b>🕋╎اوقـات الصـلاة بالتـوقيت المحلـي لعواصـم الـدول <b>\
		        ...
		        \n\nᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗵𝗲𝗼╎@Source_Theo \
	    "
	    await edit_or_reply(adzan, Source_Theo result, "html")
