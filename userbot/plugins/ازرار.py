...
# button post makker for Theo thanks to uniborg for the base
# by @XIX_A (@Source_Theo )
# edit @Source_Theo  (Theo)
...
CMD_HELP.update(
    ...
    \n•  **Example :** `.كول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/XIX_A> [ثـيـو ]<buttonurl:https://t.me/Source_Theo > [اوامر السورس]<buttonurl:https://t.me/Source_Theo >`\
    \n\n•  **Syntax : **`.كوول`\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** `.كوول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/XIX_A> [ثـيـو ]<buttonurl:https://t.me/Source_Theo > [اوامر السورس]<buttonurl:https://t.me/Source_Theo >`\
    "
    }
)
