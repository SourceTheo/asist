#𝙏𝙝𝙚𝙤 ®
#الملـف حقـوق وكتابـة مرسليو  " شخصيـاً " مـاموجود لا  سورس اجنبـي ولا عـربي ⤶ @XIX_A خاص بسـورس ⤶ 𝙏𝙝𝙚𝙤
...
async def _(event):
    ...
    if tgbotusername is not None:
        try:
            results = await event.client.inline_query(tgbotusername, "Marcelo ")
            ...
            async with bot.conversation(chat) as conv:
                try:
                    ...
                    fifth = await conv.send_message("Theo ")
