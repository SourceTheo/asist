# whois code for Theo edit by ~ @Source_Theo 
...
ZED_TEXT = Config.CUSTOM_ALIVE_TEXT or "╮•⎚ مـعلومات الـشخص مـن بـوت ثـيـو "
...
async def fetch_info(replied_user, event):
    ...
    rotbat = "「من مطـورين السورس 𓄂𓆃」" if user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 or user_id == 6367618993 else (".「  العضـو 𓅫  」.") 
    rotbat = ".「 مـالك الحساب 𓀫 」." if user_id == (await event.client.get_me()).id and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 and user_id != 6367618993 else rotbat
    ...
    caption += f"<b> ٴ•━─━─━─━─━─━─━─━─━• </b>\n"
    caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗧𝗵𝗲𝗼 𓆪 </b> - @Source_Theo  "
