...
async def vegif(zed):
    ...
    if ve_gif:
        ...
        await zed.client.send_file(
            zed.chat_id, ve_gif, caption=zed_caption, reply_to=Ti
        )
...
async def vegif(zed):
    ...
    if ve_gif2:
        ...
        await zed.client.send_file(
            zed.chat_id, ve_gif2, caption=zed_caption, reply_to=th
        )
...
async def vegif(zed):
    ...
    if ve_gif3:
        ...
        await zed.client.send_file(
            zed.chat_id, ve_gif3, caption=zed_caption, reply_to=kh
        )
...
async def vegif(zed):
    ...
    if ve_gif4:
        vec = f"**{LOVE}**\n"
        vec += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝙏𝙝𝙚𝙤ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        vec += f"**↫ المتـحركه الرابعه 𓆰.**"
        await zed.client.send_file(
            zed.chat_id, ve_gif4, caption=vec, reply_to=wh
        )
...
async def vegif(zed):
    ...
    if ve_gif5:
        ...
        await zed.client.send_file(
            zed.chat_id, ve_gif5, caption=vec, reply_to=ih
        )
...
async def vegif(zed):
    ...
    if ve_gif6:
        ...
        await zed.client.send_file(
            zed.chat_id, ve_gif6, caption=vec, reply_to=uh
        )
...
async def vegif(zed):
    ...
    if ve_gif7:
        ...
        await zed.client.send_file(
            zed.chat_id, ve_gif7, caption=vec, reply_to=oh
        )
