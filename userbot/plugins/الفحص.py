...
async def zelzalalive(event):
    ...
    ALIVE_TEXT = Config.CUSTOM_ALIVE_TEXT or "** بـوت  ثـيـو 𝗧𝗵𝗲𝗼  يعمـل .. بنجـاح ☑️ 𓆩 **"
    ZZL_IMG = Config.ALIVE_PIC or "https://graph.org/file/e66caa3ae1f673b2e7c9e.jpg"
...
**{Z_EMOJI} إصـدار ثـيـو :** `{zdver}`
**{Z_EMOJI} إصـدار البـايثون :** `{pyver}`
**{Z_EMOJI} الوقـت :** `{uptime}`
**{Z_EMOJI} المسـتخدم:** {mention}
**{Z_EMOJI} قنـاة السـورس :** [اضغـط هنـا](https://t.me/Source_Theo )"""
