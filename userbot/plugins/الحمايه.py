...
ICSS_PIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://graph.org/file/e66caa3ae1f673b2e7c9e.jpg"
)
...
if Config.PRIVATE_GROUP_ID is not None:
    ...
    async def approve_p_m(event):
        ...
        APPROVED_PMs = "𓆰 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙝𝙚𝙤 - 𝑨𝑷𝑷𝑹𝑶𝑽𝑬𝑫𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993)))
async def hehehe(event):
    if event.fwd_from:
        return
    chat = await event.get_chat()
