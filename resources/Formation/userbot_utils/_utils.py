...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            ftext += "--------BEGIN Theo TRACEBACK LOG--------"
            ftext += "\nDate: " + date
            ...
            text = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝗧𝗵𝗲𝗼 𝑬𝑹𝑹𝑶𝑹 𝑹𝑬𝑷𝑶𝑹𝑻 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝙏𝙝𝙚𝙤ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n\n"
            link = "[مطور السـورس](https://t.me/XIX_A)"
