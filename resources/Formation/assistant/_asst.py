...
# zed
K = "https://t.me/Source_Theo "
D = "** ⌔∮ مطور بوت ثـيـو **"

OWNER_ID = Config.OWNER_ID
ALIVE_NAME = Config.ALIVE_NAME if Config.ALIVE_NAME else "@Source_Theo"
...
asst_p = "https://graph.org/file/e66caa3ae1f673b2e7c9e.jpg"
asst_c = "➥ **ASSISTANT IS:** `ONLINE`\n"
asst_c += f"➥ **My Boss** : {Def} \n"
asst_c += "➥ **Heroku Database** : `AWS - Working Properly`\n"
asst_c += "➥ **Copyright** : By [𝗧𝗵𝗲𝗼](https://github.com/SourceTheo)\n"
asst_c += "[Assistant By ](https://t.me/Source_Theo )"
...
# Set Theo -Bot in @botfather
SetMsg = [
    "⌔∮ يتم تنصيب بوتك في @botfather",
    "⌔∮ يتم اكمال تنصيب بوتك في @BotFather",
    "⌔∮ تم تنصيب بوتك"
]
SetDec = "- 𝙏𝙝𝙚𝙤 𝘼𝙨𝙨𝙞𝙨𝙩𝙣𝙩 𝘽𝙤𝙩 🔱\n- ZED 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}\n- 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 ~ @Source_Theo  𖤨"
SetAbt = "- 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙝𝙚𝙤 🔱\n- ZED 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}"

# This is For Theo - Userbot only!!
